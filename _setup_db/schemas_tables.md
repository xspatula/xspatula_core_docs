...
The options for setting `process_parameter_set_value`, `process_parameter_minmax`, `process_parameter_permission`, `process_parameter_inherit` and  `process_parameter_auto_name` are detailed in the page on [Define process options - Xspatula][process_options].
...
[process_options]: ../../setup_processes/process_options/
